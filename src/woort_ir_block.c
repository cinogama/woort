...
_DEFINE_LDIDX_VREG(woort_IR_LDIDXDICTIX, WOORT_IROP_KIND_LDIDXDICTIX)
_DEFINE_LDIDX_VREG(woort_IR_LDIDXDICTRX, WOORT_IROP_KIND_LDIDXDICTRX)
_DEFINE_LDIDX_VREG(woort_IR_LDIDXDICTBX, WOORT_IROP_KIND_LDIDXDICTBX)
_DEFINE_LDIDX_VREG(woort_IR_LDIDXDICTXX, WOORT_IROP_KIND_LDIDXDICTXX)
