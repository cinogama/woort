...
typedef enum woort_IROp_Kind
{
    ...
    /* ============ 索引 (加载) ============ */
    WOORT_IROP_KIND_LDIDVEC,
    WOORT_IROP_KIND_LDIDVECX,
    WOORT_IROP_KIND_LDIDSTRUCT,
    WOORT_IROP_KIND_LDIDSTRING,

    WOORT_IROP_KIND_LDIDDICTI,
    WOORT_IROP_KIND_LDIDDICTR,
    WOORT_IROP_KIND_LDIDDICTB,
    WOORT_IROP_KIND_LDIDDICTX,
    WOORT_IROP_KIND_LDIDDICTIX,
    WOORT_IROP_KIND_LDIDDICTRX,
    WOORT_IROP_KIND_LDIDDICTBX,
    WOORT_IROP_KIND_LDIDDICTXX,

    /* ============ 索引 (存储) - vec ============ */
    WOORT_IROP_KIND_SDIDVECI,
    WOORT_IROP_KIND_SDIDVECR,
    WOORT_IROP_KIND_SDIDVECB,
    WOORT_IROP_KIND_SDIDVECX,

    /* ============ 索引 (存储) - dict ============ */
    WOORT_IROP_KIND_SDIDDICTII,
    WOORT_IROP_KIND_SDIDDICTIR,
    WOORT_IROP_KIND_SDIDDICTIB,
    WOORT_IROP_KIND_SDIDDICTIX,
    WOORT_IROP_KIND_SDIDDICTRI,
    WOORT_IROP_KIND_SDIDDICTRR,
    WOORT_IROP_KIND_SDIDDICTRB,
    WOORT_IROP_KIND_SDIDDICTRX,
    WOORT_IROP_KIND_SDIDDICTBI,
    WOORT_IROP_KIND_SDIDDICTBR,
    WOORT_IROP_KIND_SDIDDICTBB,
    WOORT_IROP_KIND_SDIDDICTBX,
    WOORT_IROP_KIND_SDIDDICTXI,
    WOORT_IROP_KIND_SDIDDICTXR,
    WOORT_IROP_KIND_SDIDDICTXB,
    WOORT_IROP_KIND_SDIDDICTXX,

    /* ============ 索引 (存储) - map ============ */
    WOORT_IROP_KIND_SDIDMAPII,
    WOORT_IROP_KIND_SDIDMAPIR,
    WOORT_IROP_KIND_SDIDMAPIB,
    WOORT_IROP_KIND_SDIDMAPIX,
    WOORT_IROP_KIND_SDIDMAPRI,
    WOORT_IROP_KIND_SDIDMAPRR,
    WOORT_IROP_KIND_SDIDMAPRB,
    WOORT_IROP_KIND_SDIDMAPRX,
    WOORT_IROP_KIND_SDIDMAPBI,
    WOORT_IROP_KIND_SDIDMAPBR,
    WOORT_IROP_KIND_SDIDMAPBB,
    WOORT_IROP_KIND_SDIDMAPBX,
    WOORT_IROP_KIND_SDIDMAPXI,
    WOORT_IROP_KIND_SDIDMAPXR,
    WOORT_IROP_KIND_SDIDMAPXB,
    WOORT_IROP_KIND_SDIDMAPXX,

    /* ============ 索引 (存储) - struct ============ */
    WOORT_IROP_KIND_SDIDSTRUCT,
    ...
    /* ============ 结构体字段推栈 ============ */
    WOORT_IROP_KIND_PUSHIDSTRUCT,
    WOORT_IROP_KIND_PUSHIDSTBOXI,
    WOORT_IROP_KIND_PUSHIDSTBOXR,
    WOORT_IROP_KIND_PUSHIDSTBOXB,
...
typedef struct woort_IROp
{
    ...
    union
    {
        ...
        /* LDIDSTRUCT/SDIDSTRUCT/PUSHIDSTRUCT/PUSHIDSTBOX* */
        uint32_t m_index;
