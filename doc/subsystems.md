...
typedef enum woort_CodeEnv_RestoreResult {
    ...
    WOORT_CODEENV_RESTORE_FAIL_INVALID_STRPOOL = 7,
    /* 常量数据错误 */
    WOORT_CODEENV_RESTORE_FAIL_TRUNCATED_DATA = 8,
    WOORT_CODEENV_RESTORE_FAIL_INVALID_CONST_TYPE = 9,
    WOORT_CODEENV_RESTORE_FAIL_INVALID_OFFSET = 10,
